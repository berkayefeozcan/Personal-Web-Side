...
<body>
	...
	<div class="text-center">
		...
		<h3 class="display-7">Search Results for '<%=request.getParameter("word")%>'</h3>
	...
	<sql:query dataSource="${snapshot}" var="result">
        SELECT * FROM `articles` WHERE (content LIKE  '%<%=request.getParameter("word")%>%') OR (title LIKE  '%<%=request.getParameter("word")%>%') ;
      </sql:query>
