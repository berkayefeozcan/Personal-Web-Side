	...
	<div class="jumbotron bg-dark text-white">
		<div class="container">
			<div class="col-md-6 px-0">
				<h3 class="display-4 font-italic">Title of a longer featured
					blog post</h3>
				<p class="lead my-3">Lorem ipsum dolor sit amet consectetur
					adipisicing elit. Quisquam non illum sequi velit vero excepturi
					facere tenetur perspiciatis necessitatibus recusandae.</p>
				<p class="lead mb-0">
				...
				<c:forEach var="row" items="${result.rows}">
					<div class="card mb-4 my-3">
						...
						<div class="card-body">
							...
							<a href="Post.jsp?pid=${row.id}"> read more ... </a>
						</div>
